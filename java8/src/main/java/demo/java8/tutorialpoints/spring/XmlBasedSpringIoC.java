...
import demo.java8.tutorialpoints.spring.xml.HelloIndia;
import demo.java8.tutorialpoints.spring.xml.HelloWorld;
import demo.java8.tutorialpoints.spring.xml.JavaCollection;
import demo.java8.tutorialpoints.spring.xml.TextEditor;
...
public class XmlBasedSpringIoC {
	...
	public static void main(String[] args) {
	    ...
	    demo.java8.tutorialpoints.spring.annotation.TextEditor textEditor = context.getBean("textEditor1", demo.java8.tutorialpoints.spring.annotation.TextEditor.class);
