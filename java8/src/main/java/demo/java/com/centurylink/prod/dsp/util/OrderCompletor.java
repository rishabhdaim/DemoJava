...
import static demo.java.com.centurylink.prod.dsp.util.DbConstants.DB_CLIENT;
import static demo.java.com.centurylink.prod.dsp.util.DbConstants.DB_SEPERATOR;
