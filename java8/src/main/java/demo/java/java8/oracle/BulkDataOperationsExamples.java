package demo.java.java8.oracle;

import java.util.List;
import demo.java.java8.oracle.Person;
...
public class BulkDataOperationsExamples {
	...
	public static void main(String... args) {
		...
		roster.stream().filter(e -> e.getGender() == Gender.MALE).forEach(e -> System.out.println(e.getName()));
		...
		double average = roster.stream().filter(p -> p.getGender() == Gender.MALE).mapToInt(Person::getAge).average()
				.getAsDouble();
