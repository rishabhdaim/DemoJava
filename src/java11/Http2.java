...
import static java11.HttpUtils.createHttpClient;
import static java11.HttpUtils.createHttpRequest;
...
public class Http2 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        HttpRequest request = createHttpRequest(URI.create("http://codefx.org"));
